...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-md border-t border-rule bg-paper/50 p-(--card-spacing)",
        className
      )}
      {...props}
    />
