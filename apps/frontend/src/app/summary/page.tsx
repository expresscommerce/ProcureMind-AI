...
export default function ExecutiveSummaryPage() {
  ...
  return (
    <ResultsWrapper>
      {(results) => {
        // Here we map the actual backend data. 
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="font-serif text-3xl font-semibold text-ink mb-2">Executive Summary</h1>
          <p className="text-ink-muted">High-level report on vendor audit findings for the board.</p>
        </div>
        <Button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle>Key Strategic Findings</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            {!hasData ? (
              <p className="text-sm text-ink-muted">No findings generated yet. Upload documents and run pipeline.</p>
